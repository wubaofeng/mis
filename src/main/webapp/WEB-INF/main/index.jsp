...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="${pageContext.request.contextPath}/emp/forward/list-employee"
                               data-index="0">人员管理</a>
                        </li>

                        <li>
                            <a class="J_menuItem" href="${pageContext.request.contextPath}/emp/forward/list-dept"
                               data-index="0">部门管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="${pageContext.request.contextPath}/emp/forward/list-role"
                               data-index="0">角色管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="${pageContext.request.contextPath}/emp/forward/list-resources"
                               data-index="0">菜单资源管理</a>
                        </li>
                    </ul>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <a href="${pageContext.request.contextPath}/login.jsp" class="roll-nav roll-right J_tabExit"><i
                    class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%"
                    src="${pageContext.request.contextPath}/emp/forward/index_v148b2" frameborder="0"
...
<script>
    /*$(function () {
        $.getJSON("${pageContext.request.contextPath}/sources/loginSources", function (data) {
            $.each(data.children, function (index, item) {
                ...
                $.each(item.children, function (index1, item1) {
                    li += '<li><a class="J_menuItem" href="${pageContext.request.contextPath}/emp/forward/' + item1.url + '" data-index="0">' + item1.name + '</a></li>';
                })
                li += '</ul></li>';
                $("#side-menu").append(li);
            })
